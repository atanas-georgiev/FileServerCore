namespace FileServerCore.Services.Users
{
    ...
    public class UserService : IUserService
    {
        ...
        private readonly FileServerCoreDbContext context;

        private readonly UserManager<User> userManager;

        private readonly IRepository<User, string> users;

        public UserService(IRepository<User> users, FileServerCoreDbContext context, UserManager<User> userManager)
        {
            this.users = users;
